...
| 033 | `ACTIVE/033_PENDING_REQUESTS_QC_IT_USER_20260829.md` | **三项待办请求书（2026-08-29）：①质控科签字——已答复关闭（2026-08-29 已授权免签字，FID 回填完成）②致信息科——病理SQLServer驱动补装+血透/电测听/气管镜/基本信息四源登记（待办）③W10系统推送类规则清单5字段模板（用户后续逐系统对接时提供）** | 031/032 交付后外部依赖收口：每件事写明致谁/请什么/具体IP库名视图名/格式模板/到位后解锁什么。 |
