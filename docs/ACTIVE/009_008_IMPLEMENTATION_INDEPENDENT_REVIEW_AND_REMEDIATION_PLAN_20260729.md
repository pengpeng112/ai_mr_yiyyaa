...
> 状态：**复核补丁已合入并生产部署（2026-07-30）**——契约维度/contract 门禁/preview fail-closed/self-supersede 消除/生产 DDL 已执行、当前结果过滤排除 contract_valid=0；"复核不通过"为本复核当时结论（2026-08-29 按 031/T1-7 回填）  
