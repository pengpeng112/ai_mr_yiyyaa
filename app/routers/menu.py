...
MENU_CATALOG = [
    ...
    {"id": "audit", "label": "审计中心", "icon": "📊", "path": "/audit", "group": "qc", "order": 22, "target": {"activeMenu": "audit"}, "hidden": False, "dev_only": False},
    {"id": "feedback", "label": "质控反馈", "icon": "💬", "path": "/feedback", "group": "qc", "order": 23, "target": {"activeMenu": "feedback"}, "hidden": False, "dev_only": False},
    ...
    {"id": "relay", "label": "前置机接收人配置", "icon": "📡", "path": "/relay", "group": "push", "order": 32, "target": {"activeMenu": "relay"}, "hidden": False, "dev_only": False},
